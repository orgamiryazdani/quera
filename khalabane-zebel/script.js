...
game = {
  ...
  checkButtonState: function () {
    const totalOptions = this.questions.options.length;
    const lighterBoxOptions = this.lighterBox.children.length;
    const darkerBoxOptions = this.darkerBox.children.length;

    if (lighterBoxOptions + darkerBoxOptions === totalOptions) {
